...
<div class="flex-w flex-sb-m p-b-52">
    <div class="flex-w flex-l-m filter-tope-group m-tb-10">
        ...
        <ul class="main-menu">
            <li>
         <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".{{ preg_replace('/[^a-zA-Z0-9]/', '', $category->title) }}">
            {{ $category->title }}
         </button>
         <ul class="sub-menu">
         <li>
            @foreach ($category->subcategories as $subcategory)
                <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".{{ preg_replace('/[^a-zA-Z0-9]/', '', $subcategory->title) }}-{{ preg_replace('/[^a-zA-Z0-9]/', '', $category->title) }}">
                    {{ $subcategory->title }}
                </button>
            @endforeach
         </li>
