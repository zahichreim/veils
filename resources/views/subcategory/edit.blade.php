...
@endsection
@section('title', 'Update '. $subcategory->title.' sub category')
@section('content')
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">Update <b>{{ $subcategory->title }}</b> sub category</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
      
        <form role="form" action="{{ route('category.subcategory.update',[$category,$subcategory]) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="box-body">
            <div class="form-group @error('title') form-group has-error @enderror">
              ...
              <input type="text" name="title" class="form-control" id="title" value="{{ $subcategory->title }}">
            ...
            <div class="form-group @error('sub_title') form-group has-error @enderror">
              ...
              <input type="text" name="sub_title" value="{{ $subcategory->sub_title }}" class="form-control" id="sub_title">
